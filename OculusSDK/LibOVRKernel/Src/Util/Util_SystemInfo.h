...
// On Windows, this is usually %LOCALAPPDATA%\Oculus.
// On Mac, this is currently the root directory "/".
//
...
//
// GetOVRPathWide() has the identical behavior as GetOVRPath(), but returns its
