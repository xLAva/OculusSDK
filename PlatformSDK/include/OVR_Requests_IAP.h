...
/// First call ::ovr_Message_IsError() to check if an error occurred.
///
/// If no error ocurred, the message will contain a payload of type ::ovrProductArrayHandle.
...
/// First call ::ovr_Message_IsError() to check if an error occurred.
///
/// If no error ocurred, the message will contain a payload of type ::ovrPurchaseArrayHandle.
...
/// Launch the checkout flow to purchase the existing product. Home tries to
/// be intelligent and handle and help fix as many errors as possible. Home will
...
/// First call ::ovr_Message_IsError() to check if an error occurred.
///
/// If no error ocurred, the message will contain a payload of type ::ovrPurchaseHandle.
