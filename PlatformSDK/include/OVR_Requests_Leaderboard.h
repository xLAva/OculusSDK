...
///
/// If no error ocurred, the message will contain a payload of type ::ovrLeaderboardEntryArrayHandle.
...
/// First call ::ovr_Message_IsError() to check if an error occurred.
///
/// If no error ocurred, the message will contain a payload of type ::ovrLeaderboardUpdateStatusHandle.
